    ...
    function (Controller, formatter, MessageToast, MessageBox) {
        ...
        return Controller.extend("project7.controller.View1", {
            ...
            onInit: function () {
                ...
                this.mode = undefined;
                var t = this;
                var path = jQuery.sap.getModulePath("project7", "/model/Employe details.json");
            ...
            onListPress: function (evt) {
                debugger
                var title = evt.getSource().mProperties.title; 
                var dd = this.getView().getModel("sOrder1").getData().Employedetails;
                var rdata = dd.find(function (element) {
                    return element.Employeid === title;
                })
                var oModel = new sap.ui.model.json.JSONModel(rdata);
                this.getView().setModel(oModel, "sOrder11");
            ...
            onAdd: function (oEvent) {
                ...
                if (!this._oDialog) {
                    ...
                    this._oDialog = sap.ui.xmlfragment(myView.getId(), "project7.view.Dialog1", this);
            ...
            onEdit: function (oEvent) {
                ...
                //       this._oDialog  = sap.ui.xmlfragment(myView.getId(), "project7.view.Dialog", this);
                //     myView.addDependent(this._oDialog );
                //       this._oDialog .open();
                // }
                // else {
